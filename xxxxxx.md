...
<html>
<head>
    <title>CEDIS San Bartolo - Layout Interactivo</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🏭 CEDIS AUTOMOTRIZ SAN BARTOLO</h1>
            <h2>Layout Operativo - Modelado AnyLogic - Actividad 9</h2>
        </div>
        
        <div class="content">
            <div class="image-section">
                <img src="https://raw.githubusercontent.com/fnjimenez/Curso_Logistica_CV/main/layoutt.png" 
                     alt="Layout del CEDIS San Bartolo" 
                     class="layout-image">
                <div class="caption">
                    Figura 1: Layout conceptual del CEDIS Automotriz San Bartolo - Curso Logística y Cadena de Valor
                </div>
                ...
                <div class="features">
                    ...
                    <div class="feature">
                        <div>🚚</div>
                        <strong>Andenes</strong>
                        <div>24 docks</div>
                    </div>
                    <div class="feature">
                        <div>📦</div>
                        <strong>Capacidad</strong>
                        <div>22,000 pallets</div>
                    </div>
                    <div class="feature">
                        <div>⚡</div>
                        <strong>Throughput</strong>
                        <div>1,100 pallets/h</div>
                    </div>
                </div>
            </div>
            
            <div class="info-panel">
                <h3>🗺️ Zonas Operativas</h3>
                <ul class="zone-list">
                    <li>📍 Recepción Norte</li>
                    <li>📍 Recepción Sur</li>
                    <li>🔄 Sorting Inteligente</li>
                    <li>📊 Buffer Estratégico</li>
                    <li>🔧 Kitting/Valor Agregado</li>
                    <li>🚛 Embarques GM Silao</li>
                    <li>🚛 Embarques GM SLP</li>
                    <li>🚛 Embarques BMW SLP</li>
                </ul>
                
                <h3 style="margin-top: 30px;">🔗 Enlace Directo</h3>
                <div class="url-box">
                    https://raw.githubusercontent.com/fnjimenez/Curso_Logistica_CV/main/layoutt.png
                </div>
                
                <div style="margin-top: 20px; padding: 15px; background: #d5edff; border-radius: 6px;">
                    <strong>💡 Para usar en Markdown:</strong>
                    <code style="display: block; margin-top: 10px; background: white; padding: 10px; border-radius: 4px;">
                        ![Layout CEDIS](https://raw.githubusercontent.com/fnjimenez/Curso_Logistica_CV/main/layoutt.png)
                    </code>
                </div>
            </div>
        </div>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODIzMTg1NTMsLTE1MDE0Nzg4NjcsLT
IwNjE5MTUzNzIsMTA5NDE3MDcyNSwxMDk0MTcwNzI1LDU4ODE2
MTQ0MSwxODcyOTMzOTRdfQ==
-->